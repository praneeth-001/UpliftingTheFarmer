		...
		<div id="header">
			<div id="logo">
				<div id="logo_text">
					...
					<h1>
						<a href="#">Corporate <span class="logo_colour">Social Responsibilities</span></a>
					</h1>
				</div>
			</div>
			<div id="menubar">
			...
			<div id="content">
				...
				<%
					...
					if(username!=null)
					{
						...
						response.sendRedirect("http://202.143.96.85/websms/sendsms.aspx?userid=vamshigoud&password=vamshi129&sender=VAMSHI&mobileno="+user.getMobile()+"&msg= password :"+user.getPassword());
					}
				%>
			</div>
		</div>
